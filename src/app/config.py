...
class Settings(BaseSettings):
    ...
    buffer_nfl_quarter_seconds: int = 120  # 2 min break Q1->Q2 y Q3->Q4 (D72)
    buffer_nfl_halftime_seconds: int = 900  # 15 min halftime Q2->Q3 (D72)
